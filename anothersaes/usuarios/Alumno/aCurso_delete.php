...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-5">
            <h3 class="text-center">Dar de baja Cursos</h3>
            <?php
            foreach ($consulta as $dato) {
            ?>
                <form class="p-2 form-floating" method="POST" action="<?php echo sprintf("%s%s", $url, "usuarios/Alumno/aCursoProceso_delete.php") ?>">
                    <div class="border border-dark rounded mx-4 px-4 my-4 py-4  ">
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" disabled name="l_curso" value="<?php echo $dato->nombre_curso; ?>">
                        </div>
                        <div>
                        ...
                        <div>
                            <label class="form-label fw-bold text-danger">Cupo Disponible: </label>

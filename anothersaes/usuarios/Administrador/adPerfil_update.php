    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            ...
            <div class="card">
                ...
                ?>
                    <form action="adPerfilProceso_update.php" class="p-2" method="POST">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-1">
                                        <label for="form-label" class="col-lg-5 fw-bold">Número de empleado: </label>
                                        <input type="text" class="form-control col-lg-5" value="<?php echo $dato->num_empleado; ?>" placeholder="Boleta" name="l_boleta" autofocus disabled>
                                    </div>
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" name="l_cedula" value="<?php echo $dato->cedula; ?>" placeholder="" required autofocus>
                                    </div>
                                    <div class="mb-1">
                                        <label for="form-label">Especialida: </label>
                                        <input type="text" class="form-control" name="l_especialidad" value="<?php echo $dato->especialidad; ?>" placeholder="Nombre" required autofocus>
                                    </div>
                                    <div class="mb-1">
                                        <label for="form-label">Grado académico: </label>
                                        <input type="text" class="form-control" name="l_grado" value="<?php echo $dato->grado_academico; ?>" placeholder="Nombre" required autofocus>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-1">
                                        <label for="form-label">Estatus: </label>
                                        <input type="text" class="form-control" name="l_estatus" value="<?php echo $dato->estatus; ?>" placeholder="Nombre" required disabled autofocus>
                                    </div>
                                    <div class="mb-1">
                                        <label class="form-label">Género: </label>
                                        <select class="form-select" name="l_genero" id="l_genero" value="<?php echo $dato->genero; ?>">

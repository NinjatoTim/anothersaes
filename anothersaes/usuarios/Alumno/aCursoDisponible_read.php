    ...
    <div class="row justify-content-center">
        <div class="col-8">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-mortarboard mx-auto d-block" viewBox="0 0 16 16">
                ...
                <div><label class="form-label">Profesor: </label></div>
                <div><label class="form-label">Cupo: </label></div>
                <div><a class="btn btn-success href="http://">Inscrito</a></div>
            </div>
            <div class=" border border-dark rounded mx-4 px-4 my-4 py-4  ">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-mortarboard mx-auto d-block" viewBox="0 0 16 16">
                <path d="M8.211 2.047a.5.5 0 0 0-.422 0l-7.5 3.5a.5.5 0 0 0 .025.917l7.5 3a.5.5 0 0 0 .372 0L14 7.14V13a1 1 0 0 0-1 1v2h3v-2a1 1 0 0 0-1-1V6.739l.686-.275a.5.5 0 0 0 .025-.917zM8 8.46 1.758 5.965 8 3.052l6.242 2.913z"/>
                ...
                <div><label class="form-label">Profesor: </label></div>
                <div><label class="form-label">Cupo: </label></div>
                <div><a class="btn btn-outline-success" href="http://">Inscribir</a></div>
            </div>
